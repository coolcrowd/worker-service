...
public class ExperimentsPlatformMode extends TableImpl<ExperimentsPlatformModeRecord> {
	 ...
	 */
	public final TableField<ExperimentsPlatformModeRecord, ExperimentsPlatformModeMode> MODE = createField("mode", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(edu.kit.ipd.crowdcontrol.workerservice.database.model.enums.ExperimentsPlatformModeMode.class), this, "");
