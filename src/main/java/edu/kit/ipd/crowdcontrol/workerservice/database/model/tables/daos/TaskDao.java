...
import edu.kit.ipd.crowdcontrol.workerservice.database.model.tables.pojos.Task;
...
public class TaskDao extends org.jooq.impl.DAOImpl<TaskRecord, Task, java.lang.Integer> {
	 ...
	 */
	public TaskDao() {
		super(edu.kit.ipd.crowdcontrol.workerservice.database.model.tables.Task.TASK, Task.class);
	}
	...
	public TaskDao(org.jooq.Configuration configuration) {
		super(edu.kit.ipd.crowdcontrol.workerservice.database.model.tables.Task.TASK, Task.class, configuration);
	}
	...
	public java.util.List<Task> fetchByRunning(java.lang.Boolean... values) {
		return fetch(edu.kit.ipd.crowdcontrol.workerservice.database.model.tables.Task.TASK.RUNNING, values);
	}
	 ...
	 */
	public java.util.List<Task> fetchByStopping(java.lang.Boolean... values) {
		return fetch(edu.kit.ipd.crowdcontrol.workerservice.database.model.tables.Task.TASK.STOPPING, values);
	}
}
