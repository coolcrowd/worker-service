...
public final class CalibrationOuterClass {
  ...
  public  static final class Calibration extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return CalibrationOuterClass.internal_static_crowdcontrol_Calibration_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return CalibrationOuterClass.internal_static_crowdcontrol_Calibration_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              CalibrationOuterClass.Calibration.class, CalibrationOuterClass.Calibration.Builder.class);
    }
    ...
    public static CalibrationOuterClass.Calibration parseFrom(
    ...
    public static CalibrationOuterClass.Calibration parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static CalibrationOuterClass.Calibration parseFrom(
    ...
    public static CalibrationOuterClass.Calibration parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static CalibrationOuterClass.Calibration parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static CalibrationOuterClass.Calibration parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(CalibrationOuterClass.Calibration prototype) {
    ...
    public static final class Builder extends
        ...
        CalibrationOuterClass.CalibrationOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return CalibrationOuterClass.internal_static_crowdcontrol_Calibration_descriptor;
      }
      ...
      public CalibrationOuterClass.Calibration getDefaultInstanceForType() {
        return CalibrationOuterClass.Calibration.getDefaultInstance();
      }

      public CalibrationOuterClass.Calibration build() {
        CalibrationOuterClass.Calibration result = buildPartial();
      ...
      public CalibrationOuterClass.Calibration buildPartial() {
        CalibrationOuterClass.Calibration result = new CalibrationOuterClass.Calibration(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof CalibrationOuterClass.Calibration) {
          return mergeFrom((CalibrationOuterClass.Calibration)other);
        } else {
      ...
      public Builder mergeFrom(CalibrationOuterClass.Calibration other) {
        if (other == CalibrationOuterClass.Calibration.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        CalibrationOuterClass.Calibration parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (CalibrationOuterClass.Calibration) e.getUnfinishedMessage();
          throw e;
        } finally {
    ...
    private static final CalibrationOuterClass.Calibration DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new CalibrationOuterClass.Calibration();
    }

    public static CalibrationOuterClass.Calibration getDefaultInstance() {
