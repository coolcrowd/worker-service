...
public final class ViewOuterClass {
  ...
  public interface ViewOrBuilder extends
     ...
     * <code>optional .crowdcontrol.View.Type type = 2;</code>
     */
    ViewOuterClass.View.Type getType();
     ...
     */
    java.util.List<ViewOuterClass.View.Answer>
        getAnswersList();
    /**
     * <code>repeated .crowdcontrol.View.Answer answers = 6;</code>
     */
    ViewOuterClass.View.Answer getAnswers(int index);
    /**
     * <code>repeated .crowdcontrol.View.Answer answers = 6;</code>
     */
    int getAnswersCount();
     ...
     * <code>repeated .crowdcontrol.View.Answer answers = 6;</code>
     */
    java.util.List<? extends ViewOuterClass.View.AnswerOrBuilder>
        getAnswersOrBuilderList();
    /**
     * <code>repeated .crowdcontrol.View.Answer answers = 6;</code>
     */
    ViewOuterClass.View.AnswerOrBuilder getAnswersOrBuilder(
        int index);

    /**
     * <code>repeated string constraints = 7;</code>
     */
     ...
     */
    java.util.List<ViewOuterClass.View.Picture>
        getPicturesList();
    /**
     * <code>repeated .crowdcontrol.View.Picture pictures = 8;</code>
     */
    ViewOuterClass.View.Picture getPictures(int index);
    /**
     * <code>repeated .crowdcontrol.View.Picture pictures = 8;</code>
     */
     ...
     * <code>repeated .crowdcontrol.View.Picture pictures = 8;</code>
     */
    java.util.List<? extends ViewOuterClass.View.PictureOrBuilder>
        getPicturesOrBuilderList();
    /**
     * <code>repeated .crowdcontrol.View.Picture pictures = 8;</code>
     */
    ViewOuterClass.View.PictureOrBuilder getPicturesOrBuilder(
        int index);

    /**
     * <code>repeated .crowdcontrol.View.Calibrations calibrations = 9;</code>
     */
    java.util.List<ViewOuterClass.View.Calibrations>
        getCalibrationsList();
    /**
     * <code>repeated .crowdcontrol.View.Calibrations calibrations = 9;</code>
     */
    ViewOuterClass.View.Calibrations getCalibrations(int index);
    /**
     * <code>repeated .crowdcontrol.View.Calibrations calibrations = 9;</code>
     */
     ...
     * <code>repeated .crowdcontrol.View.Calibrations calibrations = 9;</code>
     */
    java.util.List<? extends ViewOuterClass.View.CalibrationsOrBuilder>
        getCalibrationsOrBuilderList();
    /**
     * <code>repeated .crowdcontrol.View.Calibrations calibrations = 9;</code>
     */
    ViewOuterClass.View.CalibrationsOrBuilder getCalibrationsOrBuilder(
        int index);
  }
  /**
  ...
  public  static final class View extends
          ...
          switch (tag) {
            ...
            case 50: {
              if (!((mutable_bitField0_ & 0x00000020) == 0x00000020)) {
                answers_ = new java.util.ArrayList<ViewOuterClass.View.Answer>();
                mutable_bitField0_ |= 0x00000020;
              }
              answers_.add(input.readMessage(ViewOuterClass.View.Answer.parser(), extensionRegistry));
              break;
            }
            case 58: {
              String s = input.readStringRequireUtf8();
            ...
            case 66: {
              if (!((mutable_bitField0_ & 0x00000080) == 0x00000080)) {
                pictures_ = new java.util.ArrayList<ViewOuterClass.View.Picture>();
                mutable_bitField0_ |= 0x00000080;
              }
              pictures_.add(input.readMessage(ViewOuterClass.View.Picture.parser(), extensionRegistry));
              break;
            }
            case 74: {
              if (!((mutable_bitField0_ & 0x00000100) == 0x00000100)) {
                calibrations_ = new java.util.ArrayList<ViewOuterClass.View.Calibrations>();
                mutable_bitField0_ |= 0x00000100;
              }
              calibrations_.add(input.readMessage(ViewOuterClass.View.Calibrations.parser(), extensionRegistry));
              break;
            }
          }
        }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ViewOuterClass.internal_static_crowdcontrol_View_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ViewOuterClass.internal_static_crowdcontrol_View_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ViewOuterClass.View.class, ViewOuterClass.View.Builder.class);
    }
    ...
    public enum Type
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return ViewOuterClass.View.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public  static final class Picture extends
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ViewOuterClass.internal_static_crowdcontrol_View_Picture_descriptor;
      }

      protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
          internalGetFieldAccessorTable() {
        return ViewOuterClass.internal_static_crowdcontrol_View_Picture_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                ViewOuterClass.View.Picture.class, ViewOuterClass.View.Picture.Builder.class);
      }
      ...
      public static ViewOuterClass.View.Picture parseFrom(
      ...
      public static ViewOuterClass.View.Picture parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      public static ViewOuterClass.View.Picture parseFrom(
      ...
      public static ViewOuterClass.View.Picture parseFrom(java.io.InputStream input)
          throws java.io.IOException {
      ...
      public static ViewOuterClass.View.Picture parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return PARSER.parseDelimitedFrom(input);
      }
      public static ViewOuterClass.View.Picture parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
      ...
      public static Builder newBuilder(ViewOuterClass.View.Picture prototype) {
      ...
      public static final class Builder extends
          ...
          ViewOuterClass.View.PictureOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
          return ViewOuterClass.internal_static_crowdcontrol_View_Picture_descriptor;
        }
        ...
        public ViewOuterClass.View.Picture getDefaultInstanceForType() {
          return ViewOuterClass.View.Picture.getDefaultInstance();
        }

        public ViewOuterClass.View.Picture build() {
          ViewOuterClass.View.Picture result = buildPartial();
        ...
        public ViewOuterClass.View.Picture buildPartial() {
          ViewOuterClass.View.Picture result = new ViewOuterClass.View.Picture(this);
          result.url_ = url_;
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
          if (other instanceof ViewOuterClass.View.Picture) {
            return mergeFrom((ViewOuterClass.View.Picture)other);
          } else {
        ...
        public Builder mergeFrom(ViewOuterClass.View.Picture other) {
          if (other == ViewOuterClass.View.Picture.getDefaultInstance()) return this;
        ...
        public Builder mergeFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
          ViewOuterClass.View.Picture parsedMessage = null;
          try {
            parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
          } catch (com.google.protobuf.InvalidProtocolBufferException e) {
            parsedMessage = (ViewOuterClass.View.Picture) e.getUnfinishedMessage();
            throw e;
          } finally {
  ...
  checkByteStringIsUtf8(value);
      ...
      private static final ViewOuterClass.View.Picture DEFAULT_INSTANCE;
      static {
        DEFAULT_INSTANCE = new ViewOuterClass.View.Picture();
      }

      public static ViewOuterClass.View.Picture getDefaultInstance() {
    ...
    public  static final class Calibrations extends
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ViewOuterClass.internal_static_crowdcontrol_View_Calibrations_descriptor;
      }

      protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
          internalGetFieldAccessorTable() {
        return ViewOuterClass.internal_static_crowdcontrol_View_Calibrations_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                ViewOuterClass.View.Calibrations.class, ViewOuterClass.View.Calibrations.Builder.class);
      }
      ...
      private static final long serialVersionUID = 0L;
      public static ViewOuterClass.View.Calibrations parseFrom(
          com.google.protobuf.ByteString data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      ...
      public static ViewOuterClass.View.Calibrations parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      public static ViewOuterClass.View.Calibrations parseFrom(
      ...
      public static ViewOuterClass.View.Calibrations parseFrom(java.io.InputStream input)
          throws java.io.IOException {
        return PARSER.parseFrom(input);
      }
      public static ViewOuterClass.View.Calibrations parseFrom(
      ...
      public static ViewOuterClass.View.Calibrations parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return PARSER.parseDelimitedFrom(input);
      }
      public static ViewOuterClass.View.Calibrations parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        return PARSER.parseDelimitedFrom(input, extensionRegistry);
      ...
      public static Builder newBuilder(ViewOuterClass.View.Calibrations prototype) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
      }
      public Builder toBuilder() {
        return this == DEFAULT_INSTANCE
      ...
      public static final class Builder extends
          ...
          ViewOuterClass.View.CalibrationsOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
          return ViewOuterClass.internal_static_crowdcontrol_View_Calibrations_descriptor;
        }
        ...
        public ViewOuterClass.View.Calibrations getDefaultInstanceForType() {
          return ViewOuterClass.View.Calibrations.getDefaultInstance();
        }

        public ViewOuterClass.View.Calibrations build() {
          ViewOuterClass.View.Calibrations result = buildPartial();
          if (!result.isInitialized()) {
            throw newUninitializedMessageException(result);
          }
          return result;
        ...
        public ViewOuterClass.View.Calibrations buildPartial() {
          ViewOuterClass.View.Calibrations result = new ViewOuterClass.View.Calibrations(this);
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
          if (other instanceof ViewOuterClass.View.Calibrations) {
            return mergeFrom((ViewOuterClass.View.Calibrations)other);
          } else {
            super.mergeFrom(other);
            return this;
          }
        ...
        public Builder mergeFrom(ViewOuterClass.View.Calibrations other) {
          if (other == ViewOuterClass.View.Calibrations.getDefaultInstance()) return this;
        ...
        public Builder mergeFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
          ViewOuterClass.View.Calibrations parsedMessage = null;
          try {
            parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
          } catch (com.google.protobuf.InvalidProtocolBufferException e) {
            parsedMessage = (ViewOuterClass.View.Calibrations) e.getUnfinishedMessage();
            throw e;
          } finally {
            if (parsedMessage != null) {
              mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
      ...
      private static final ViewOuterClass.View.Calibrations DEFAULT_INSTANCE;
      static {
        DEFAULT_INSTANCE = new ViewOuterClass.View.Calibrations();
      }

      public static ViewOuterClass.View.Calibrations getDefaultInstance() {
        return DEFAULT_INSTANCE;
      }
    ...
    public  static final class Answer extends
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ViewOuterClass.internal_static_crowdcontrol_View_Answer_descriptor;
      }

      protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
          internalGetFieldAccessorTable() {
        return ViewOuterClass.internal_static_crowdcontrol_View_Answer_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                ViewOuterClass.View.Answer.class, ViewOuterClass.View.Answer.Builder.class);
      }
      ...
      private static final long serialVersionUID = 0L;
      public static ViewOuterClass.View.Answer parseFrom(
          com.google.protobuf.ByteString data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      ...
      public static ViewOuterClass.View.Answer parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      public static ViewOuterClass.View.Answer parseFrom(
      ...
      public static ViewOuterClass.View.Answer parseFrom(java.io.InputStream input)
          throws java.io.IOException {
        return PARSER.parseFrom(input);
      }
      public static ViewOuterClass.View.Answer parseFrom(
      ...
      public static ViewOuterClass.View.Answer parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return PARSER.parseDelimitedFrom(input);
      }
      public static ViewOuterClass.View.Answer parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        return PARSER.parseDelimitedFrom(input, extensionRegistry);
      ...
      public static Builder newBuilder(ViewOuterClass.View.Answer prototype) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
      }
      public Builder toBuilder() {
        return this == DEFAULT_INSTANCE
      ...
      public static final class Builder extends
          ...
          ViewOuterClass.View.AnswerOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
          return ViewOuterClass.internal_static_crowdcontrol_View_Answer_descriptor;
        }
        ...
        // Construct using edu.ipd.kit.crowdcontrol.workerservice.proto.ViewOuterClass.View.Answer.newBuilder()
        private Builder() {
          maybeForceBuilderInitialization();
        }
        ...
        public ViewOuterClass.View.Answer getDefaultInstanceForType() {
          return ViewOuterClass.View.Answer.getDefaultInstance();
        }

        public ViewOuterClass.View.Answer build() {
          ViewOuterClass.View.Answer result = buildPartial();
          if (!result.isInitialized()) {
            throw newUninitializedMessageException(result);
          }
          return result;
        ...
        public ViewOuterClass.View.Answer buildPartial() {
          ViewOuterClass.View.Answer result = new ViewOuterClass.View.Answer(this);
          result.id_ = id_;
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
          if (other instanceof ViewOuterClass.View.Answer) {
            return mergeFrom((ViewOuterClass.View.Answer)other);
          } else {
            super.mergeFrom(other);
            return this;
          }
        ...
        public Builder mergeFrom(ViewOuterClass.View.Answer other) {
          if (other == ViewOuterClass.View.Answer.getDefaultInstance()) return this;
          if (other.getId() != 0) {
            setId(other.getId());
          }
        ...
        public Builder mergeFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
          ViewOuterClass.View.Answer parsedMessage = null;
          try {
            parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
          } catch (com.google.protobuf.InvalidProtocolBufferException e) {
            parsedMessage = (ViewOuterClass.View.Answer) e.getUnfinishedMessage();
            throw e;
          } finally {
            if (parsedMessage != null) {
              mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
      ...
      private static final ViewOuterClass.View.Answer DEFAULT_INSTANCE;
      static {
        DEFAULT_INSTANCE = new ViewOuterClass.View.Answer();
      }

      public static ViewOuterClass.View.Answer getDefaultInstance() {
        return DEFAULT_INSTANCE;
      }
     ...
     * <code>optional .crowdcontrol.View.Type type = 2;</code>
     */
    public ViewOuterClass.View.Type getType() {
      ViewOuterClass.View.Type result = ViewOuterClass.View.Type.valueOf(type_);
      return result == null ? ViewOuterClass.View.Type.UNRECOGNIZED : result;
    }
    ...
    private java.util.List<ViewOuterClass.View.Answer> answers_;
    /**
     * <code>repeated .crowdcontrol.View.Answer answers = 6;</code>
     */
    public java.util.List<ViewOuterClass.View.Answer> getAnswersList() {
      return answers_;
    }
    /**
     * <code>repeated .crowdcontrol.View.Answer answers = 6;</code>
     */
    public java.util.List<? extends ViewOuterClass.View.AnswerOrBuilder>
        getAnswersOrBuilderList() {
      return answers_;
    }
    /**
     ...
     * <code>repeated .crowdcontrol.View.Answer answers = 6;</code>
     */
    public ViewOuterClass.View.Answer getAnswers(int index) {
      return answers_.get(index);
    }
    /**
     * <code>repeated .crowdcontrol.View.Answer answers = 6;</code>
     */
    public ViewOuterClass.View.AnswerOrBuilder getAnswersOrBuilder(
        int index) {
      return answers_.get(index);
    }
    ...
    private java.util.List<ViewOuterClass.View.Picture> pictures_;
    /**
     * <code>repeated .crowdcontrol.View.Picture pictures = 8;</code>
     */
    public java.util.List<ViewOuterClass.View.Picture> getPicturesList() {
      return pictures_;
    }
    /**
     * <code>repeated .crowdcontrol.View.Picture pictures = 8;</code>
     */
    public java.util.List<? extends ViewOuterClass.View.PictureOrBuilder>
        getPicturesOrBuilderList() {
      return pictures_;
    }
    /**
     ...
     * <code>repeated .crowdcontrol.View.Picture pictures = 8;</code>
     */
    public ViewOuterClass.View.Picture getPictures(int index) {
      return pictures_.get(index);
    }
    /**
     * <code>repeated .crowdcontrol.View.Picture pictures = 8;</code>
     */
    public ViewOuterClass.View.PictureOrBuilder getPicturesOrBuilder(
        int index) {
      return pictures_.get(index);
    }

    public static final int CALIBRATIONS_FIELD_NUMBER = 9;
    private java.util.List<ViewOuterClass.View.Calibrations> calibrations_;
    /**
     * <code>repeated .crowdcontrol.View.Calibrations calibrations = 9;</code>
     */
    public java.util.List<ViewOuterClass.View.Calibrations> getCalibrationsList() {
      return calibrations_;
    }
    /**
     * <code>repeated .crowdcontrol.View.Calibrations calibrations = 9;</code>
     */
    public java.util.List<? extends ViewOuterClass.View.CalibrationsOrBuilder>
        getCalibrationsOrBuilderList() {
      return calibrations_;
    }
    /**
     ...
     * <code>repeated .crowdcontrol.View.Calibrations calibrations = 9;</code>
     */
    public ViewOuterClass.View.Calibrations getCalibrations(int index) {
      return calibrations_.get(index);
    }
    /**
     * <code>repeated .crowdcontrol.View.Calibrations calibrations = 9;</code>
     */
    public ViewOuterClass.View.CalibrationsOrBuilder getCalibrationsOrBuilder(
        int index) {
      return calibrations_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (type_ != ViewOuterClass.View.Type.FINISHED.getNumber()) {
      ...
      for (int i = 0; i < constraints_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 7, constraints_.getRaw(i));
      }
    ...
    private static final long serialVersionUID = 0L;
    public static ViewOuterClass.View parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static ViewOuterClass.View parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ViewOuterClass.View parseFrom(
    ...
    public static ViewOuterClass.View parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static ViewOuterClass.View parseFrom(
    ...
    public static ViewOuterClass.View parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static ViewOuterClass.View parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder(ViewOuterClass.View prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() {
      return this == DEFAULT_INSTANCE
    ...
    public static final class Builder extends
      ...
      public ViewOuterClass.View getDefaultInstanceForType() {
        return ViewOuterClass.View.getDefaultInstance();
      }

      public ViewOuterClass.View build() {
        ViewOuterClass.View result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public ViewOuterClass.View buildPartial() {
        ViewOuterClass.View result = new ViewOuterClass.View(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ViewOuterClass.View) {
          return mergeFrom((ViewOuterClass.View)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(ViewOuterClass.View other) {
        if (other == ViewOuterClass.View.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ViewOuterClass.View parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ViewOuterClass.View) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
       ...
       * <code>optional .crowdcontrol.View.Type type = 2;</code>
       */
      public Builder setType(ViewOuterClass.View.Type value) {
        if (value == null) {
          throw new NullPointerException();
        }
  ...
  checkByteStringIsUtf8(value);
      ...
      private void ensureAnswersIsMutable() {
        if (!((bitField0_ & 0x00000020) == 0x00000020)) {
          answers_ = new java.util.ArrayList<ViewOuterClass.View.Answer>(answers_);
          bitField0_ |= 0x00000020;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          ViewOuterClass.View.Answer, ViewOuterClass.View.Answer.Builder, ViewOuterClass.View.AnswerOrBuilder> answersBuilder_;
      ...
      public Builder setAnswers(
          int index, ViewOuterClass.View.Answer value) {
        if (answersBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setAnswers(
          int index, ViewOuterClass.View.Answer.Builder builderForValue) {
        if (answersBuilder_ == null) {
          ensureAnswersIsMutable();
       ...
       * <code>repeated .crowdcontrol.View.Answer answers = 6;</code>
       */
      public Builder addAnswers(ViewOuterClass.View.Answer value) {
        if (answersBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addAnswers(
          ViewOuterClass.View.Answer.Builder builderForValue) {
        if (answersBuilder_ == null) {
          ensureAnswersIsMutable();
      ...
      public Builder addAllAnswers(
          java.lang.Iterable<? extends ViewOuterClass.View.Answer> values) {
        if (answersBuilder_ == null) {
          ensureAnswersIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, answers_);
       ...
       * <code>repeated .crowdcontrol.View.Answer answers = 6;</code>
       */
      public ViewOuterClass.View.Answer.Builder getAnswersBuilder(
          int index) {
       ...
       * <code>repeated .crowdcontrol.View.Answer answers = 6;</code>
       */
      public ViewOuterClass.View.Answer.Builder addAnswersBuilder() {
        return getAnswersFieldBuilder().addBuilder(
            ViewOuterClass.View.Answer.getDefaultInstance());
      }
      /**
       * <code>repeated .crowdcontrol.View.Answer answers = 6;</code>
       */
      public ViewOuterClass.View.Answer.Builder addAnswersBuilder(
          int index) {
        return getAnswersFieldBuilder().addBuilder(
            index, ViewOuterClass.View.Answer.getDefaultInstance());
      }
      /**
       * <code>repeated .crowdcontrol.View.Answer answers = 6;</code>
       */
      public java.util.List<ViewOuterClass.View.Answer.Builder>
           getAnswersBuilderList() {
        return getAnswersFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          ViewOuterClass.View.Answer, ViewOuterClass.View.Answer.Builder, ViewOuterClass.View.AnswerOrBuilder>
          getAnswersFieldBuilder() {
        if (answersBuilder_ == null) {
  ...
  checkByteStringIsUtf8(value);
      ...
      private void ensurePicturesIsMutable() {
        if (!((bitField0_ & 0x00000080) == 0x00000080)) {
          pictures_ = new java.util.ArrayList<ViewOuterClass.View.Picture>(pictures_);
          bitField0_ |= 0x00000080;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          ViewOuterClass.View.Picture, ViewOuterClass.View.Picture.Builder, ViewOuterClass.View.PictureOrBuilder> picturesBuilder_;
      ...
      public Builder setPictures(
          int index, ViewOuterClass.View.Picture value) {
        if (picturesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setPictures(
          int index, ViewOuterClass.View.Picture.Builder builderForValue) {
        if (picturesBuilder_ == null) {
          ensurePicturesIsMutable();
       ...
       * <code>repeated .crowdcontrol.View.Picture pictures = 8;</code>
       */
      public Builder addPictures(ViewOuterClass.View.Picture value) {
        if (picturesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addPictures(
          ViewOuterClass.View.Picture.Builder builderForValue) {
        if (picturesBuilder_ == null) {
          ensurePicturesIsMutable();
      ...
      public Builder addAllPictures(
          java.lang.Iterable<? extends ViewOuterClass.View.Picture> values) {
        if (picturesBuilder_ == null) {
          ensurePicturesIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, pictures_);
       ...
       * <code>repeated .crowdcontrol.View.Picture pictures = 8;</code>
       */
      public ViewOuterClass.View.Picture.Builder getPicturesBuilder(
          int index) {
       ...
       * <code>repeated .crowdcontrol.View.Picture pictures = 8;</code>
       */
      public ViewOuterClass.View.Picture.Builder addPicturesBuilder() {
        return getPicturesFieldBuilder().addBuilder(
            ViewOuterClass.View.Picture.getDefaultInstance());
      }
      /**
       * <code>repeated .crowdcontrol.View.Picture pictures = 8;</code>
       */
      public ViewOuterClass.View.Picture.Builder addPicturesBuilder(
          int index) {
        return getPicturesFieldBuilder().addBuilder(
            index, ViewOuterClass.View.Picture.getDefaultInstance());
      }
      /**
       * <code>repeated .crowdcontrol.View.Picture pictures = 8;</code>
       */
      public java.util.List<ViewOuterClass.View.Picture.Builder>
           getPicturesBuilderList() {
        return getPicturesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          ViewOuterClass.View.Picture, ViewOuterClass.View.Picture.Builder, ViewOuterClass.View.PictureOrBuilder>
          getPicturesFieldBuilder() {
        if (picturesBuilder_ == null) {
      ...
      private void ensureCalibrationsIsMutable() {
        if (!((bitField0_ & 0x00000100) == 0x00000100)) {
          calibrations_ = new java.util.ArrayList<ViewOuterClass.View.Calibrations>(calibrations_);
          bitField0_ |= 0x00000100;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilder<
          ViewOuterClass.View.Calibrations, ViewOuterClass.View.Calibrations.Builder, ViewOuterClass.View.CalibrationsOrBuilder> calibrationsBuilder_;
      ...
      public Builder setCalibrations(
          int index, ViewOuterClass.View.Calibrations value) {
        if (calibrationsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setCalibrations(
          int index, ViewOuterClass.View.Calibrations.Builder builderForValue) {
        if (calibrationsBuilder_ == null) {
          ensureCalibrationsIsMutable();
       ...
       * <code>repeated .crowdcontrol.View.Calibrations calibrations = 9;</code>
       */
      public Builder addCalibrations(ViewOuterClass.View.Calibrations value) {
        if (calibrationsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addCalibrations(
          ViewOuterClass.View.Calibrations.Builder builderForValue) {
        if (calibrationsBuilder_ == null) {
          ensureCalibrationsIsMutable();
      ...
      public Builder addAllCalibrations(
          java.lang.Iterable<? extends ViewOuterClass.View.Calibrations> values) {
        if (calibrationsBuilder_ == null) {
          ensureCalibrationsIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .crowdcontrol.View.Calibrations calibrations = 9;</code>
       */
      public ViewOuterClass.View.Calibrations.Builder getCalibrationsBuilder(
          int index) {
       ...
       * <code>repeated .crowdcontrol.View.Calibrations calibrations = 9;</code>
       */
      public ViewOuterClass.View.Calibrations.Builder addCalibrationsBuilder() {
        return getCalibrationsFieldBuilder().addBuilder(
            ViewOuterClass.View.Calibrations.getDefaultInstance());
      }
      /**
       * <code>repeated .crowdcontrol.View.Calibrations calibrations = 9;</code>
       */
      public ViewOuterClass.View.Calibrations.Builder addCalibrationsBuilder(
          int index) {
        return getCalibrationsFieldBuilder().addBuilder(
            index, ViewOuterClass.View.Calibrations.getDefaultInstance());
      }
      /**
       * <code>repeated .crowdcontrol.View.Calibrations calibrations = 9;</code>
       */
      public java.util.List<ViewOuterClass.View.Calibrations.Builder>
           getCalibrationsBuilderList() {
        return getCalibrationsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          ViewOuterClass.View.Calibrations, ViewOuterClass.View.Calibrations.Builder, ViewOuterClass.View.CalibrationsOrBuilder>
          getCalibrationsFieldBuilder() {
        if (calibrationsBuilder_ == null) {
    ...
    private static final ViewOuterClass.View DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ViewOuterClass.View();
    }

    public static ViewOuterClass.View getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\nview.proto\022\014crowdcontrol\"\216\004\n\004View\022\020\n\010w" +
      "orkerID\030\001 \001(\005\022%\n\004type\030\002 \001(\0162\027.crowdcontr" +
      "ol.View.Type\022\r\n\005title\030\003 \001(\t\022\023\n\013descripti" +
      "on\030\004 \001(\t\022\014\n\004task\030\005 \001(\005\022*\n\007answers\030\006 \003(\0132" +
      "\031.crowdcontrol.View.Answer\022\023\n\013constraint" +
      "s\030\007 \003(\t\022,\n\010pictures\030\010 \003(\0132\032.crowdcontrol" +
      ".View.Picture\0225\n\014calibrations\030\t \003(\0132\037.cr" +
      "owdcontrol.View.Calibrations\032+\n\007Picture\022" +
      "\013\n\003url\030\001 \001(\t\022\023\n\013url_license\030\002 \001(\t\032X\n\014Cal" +
      "ibrations\022\020\n\010question\030\001 \001(\t\022\025\n\ranswerOpt",
      "ions\030\002 \003(\t\022\023\n\013description\030\003 \001(\t\022\n\n\002id\030\004 " +
      "\001(\005\032$\n\006Answer\022\n\n\002id\030\001 \001(\005\022\016\n\006answer\030\002 \001(" +
      "\t\"H\n\004Type\022\014\n\010FINISHED\020\000\022\n\n\006ANSWER\020\001\022\n\n\006R" +
      "ATING\020\002\022\017\n\013CALIBRATION\020\003\022\t\n\005EMAIL\020\004B.\n,e" +
      "du.ipd.kit.crowdcontrol.workerservice.pr" +
      "otob\006proto3"
    };
