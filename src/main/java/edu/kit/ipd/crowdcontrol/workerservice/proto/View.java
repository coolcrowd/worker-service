...
public  final class View extends
  ...
  private View() {
    ...
    title_ = "";
    description_ = "";
    answerReservations_ = java.util.Collections.emptyList();
    answerType_ = "";
  ...
  private View(
    ...
    try {
        ...
        switch (tag) {
          ...
          case 40: {
            if (!((mutable_bitField0_ & 0x00000010) == 0x00000010)) {
              answerReservations_ = new java.util.ArrayList<java.lang.Integer>();
              mutable_bitField0_ |= 0x00000010;
            }
            answerReservations_.add(input.readInt32());
            break;
          }
          case 42: {
      ...
      if (((mutable_bitField0_ & 0x00000010) == 0x00000010)) {
        answerReservations_ = java.util.Collections.unmodifiableList(answerReservations_);
      }
      if (((mutable_bitField0_ & 0x00000040) == 0x00000040)) {
  ...
  public static final int ANSWER_RESERVATIONS_FIELD_NUMBER = 5;
  private java.util.List<java.lang.Integer> answerReservations_;
  /**
   * <code>repeated int32 answer_reservations = 5;</code>
   */
  public java.util.List<java.lang.Integer>
      getAnswerReservationsList() {
    return answerReservations_;
  }
  /**
   * <code>repeated int32 answer_reservations = 5;</code>
   */
  public int getAnswerReservationsCount() {
    return answerReservations_.size();
  }
  /**
   * <code>repeated int32 answer_reservations = 5;</code>
   */
  public int getAnswerReservations(int index) {
    return answerReservations_.get(index);
  }
  private int answerReservationsMemoizedSerializedSize = -1;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!getAuthorizationBytes().isEmpty()) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, authorization_);
    }
    ...
    if (getAnswerReservationsList().size() > 0) {
      output.writeRawVarint32(42);
      output.writeRawVarint32(answerReservationsMemoizedSerializedSize);
    }
    for (int i = 0; i < answerReservations_.size(); i++) {
      output.writeInt32NoTag(answerReservations_.get(i));
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!getAuthorizationBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, authorization_);
    }
    if (type_ != edu.kit.ipd.crowdcontrol.workerservice.proto.View.Type.FINISHED.getNumber()) {
      size += com.google.protobuf.CodedOutputStream
    ...
    }
    {
      ...
      for (int i = 0; i < answerReservations_.size(); i++) {
        dataSize += com.google.protobuf.CodedOutputStream
          .computeInt32SizeNoTag(answerReservations_.get(i));
      }
      size += dataSize;
      if (!getAnswerReservationsList().isEmpty()) {
        size += 1;
        size += com.google.protobuf.CodedOutputStream
            .computeInt32SizeNoTag(dataSize);
      }
      answerReservationsMemoizedSerializedSize = dataSize;
    }
    if (!getAnswerTypeBytes().isEmpty()) {
  ...
  public static final class Builder extends
    ...
    public edu.kit.ipd.crowdcontrol.workerservice.proto.View buildPartial() {
      ...
      result.answerReservations_ = answerReservations_;
    ...
    public Builder mergeFrom(edu.kit.ipd.crowdcontrol.workerservice.proto.View other) {
      ...
      if (!other.answerReservations_.isEmpty()) {
        if (answerReservations_.isEmpty()) {
          answerReservations_ = other.answerReservations_;
          bitField0_ = (bitField0_ & ~0x00000010);
        } else {
          ensureAnswerReservationsIsMutable();
          answerReservations_.addAll(other.answerReservations_);
        }
        onChanged();
      }
      ...
      if (answersToRateBuilder_ == null) {
        ...
        if (!other.answersToRate_.isEmpty()) {
          if (answersToRateBuilder_.isEmpty()) {
            ...
            answersToRateBuilder_.addAllMessages(other.answersToRate_);
          }
        }
      }
      if (ratingOptionsBuilder_ == null) {
  ...
  checkByteStringIsUtf8(value);
    ...
    private java.util.List<java.lang.Integer> answerReservations_ = java.util.Collections.emptyList();
    private void ensureAnswerReservationsIsMutable() {
      if (!((bitField0_ & 0x00000010) == 0x00000010)) {
        answerReservations_ = new java.util.ArrayList<java.lang.Integer>(answerReservations_);
    ...
    public java.util.List<java.lang.Integer>
        getAnswerReservationsList() {
      return java.util.Collections.unmodifiableList(answerReservations_);
    }
    /**
     * <code>repeated int32 answer_reservations = 5;</code>
     */
     ...
     * <code>repeated int32 answer_reservations = 5;</code>
     */
    public Builder setAnswerReservations(
        int index, int value) {
      ensureAnswerReservationsIsMutable();
      answerReservations_.set(index, value);
      onChanged();
      return this;
    }
    /**
     * <code>repeated int32 answer_reservations = 5;</code>
     */
    public Builder addAnswerReservations(int value) {
      ensureAnswerReservationsIsMutable();
      answerReservations_.add(value);
      onChanged();
      return this;
    }
    /**
     * <code>repeated int32 answer_reservations = 5;</code>
     */
    public Builder addAllAnswerReservations(
        java.lang.Iterable<? extends java.lang.Integer> values) {
      ensureAnswerReservationsIsMutable();
      com.google.protobuf.AbstractMessageLite.Builder.addAll(
          values, answerReservations_);
      onChanged();
      return this;
    }
    /**
     * <code>repeated int32 answer_reservations = 5;</code>
     */
    public Builder clearAnswerReservations() {
      answerReservations_ = java.util.Collections.emptyList();
      bitField0_ = (bitField0_ & ~0x00000010);
      onChanged();
      return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    public java.util.List<edu.kit.ipd.crowdcontrol.workerservice.proto.View.Answer> getAnswersToRateList() {
      if (answersToRateBuilder_ == null) {
        return java.util.Collections.unmodifiableList(answersToRate_);
      } else {
        return answersToRateBuilder_.getMessageList();
      }
    }
    /**
     * <code>repeated .crowdcontrol.View.Answer answers_to_rate = 7;</code>
    ...
    public int getAnswersToRateCount() {
      if (answersToRateBuilder_ == null) {
        ...
        return answersToRateBuilder_.getCount();
      }
    }
    /**
     * <code>repeated .crowdcontrol.View.Answer answers_to_rate = 7;</code>
    ...
    public edu.kit.ipd.crowdcontrol.workerservice.proto.View.Answer getAnswersToRate(int index) {
      if (answersToRateBuilder_ == null) {
        ...
        return answersToRateBuilder_.getMessage(index);
      }
    }
    /**
     * <code>repeated .crowdcontrol.View.Answer answers_to_rate = 7;</code>
    ...
    public Builder setAnswersToRate(
      ...
      if (answersToRateBuilder_ == null) {
        ...
        ensureAnswersToRateIsMutable();
        answersToRate_.set(index, value);
        onChanged();
      } else {
        answersToRateBuilder_.setMessage(index, value);
      }
      return this;
    }
    /**
    ...
    public Builder setAnswersToRate(
      ...
      if (answersToRateBuilder_ == null) {
        ensureAnswersToRateIsMutable();
        answersToRate_.set(index, builderForValue.build());
        onChanged();
      } else {
        answersToRateBuilder_.setMessage(index, builderForValue.build());
      }
      return this;
    }
    /**
    ...
    public Builder addAnswersToRate(edu.kit.ipd.crowdcontrol.workerservice.proto.View.Answer value) {
      if (answersToRateBuilder_ == null) {
        ...
        ensureAnswersToRateIsMutable();
        answersToRate_.add(value);
        onChanged();
      } else {
        answersToRateBuilder_.addMessage(value);
      }
      return this;
    }
    /**
    ...
    public Builder addAnswersToRate(
      ...
      if (answersToRateBuilder_ == null) {
        ...
        ensureAnswersToRateIsMutable();
        answersToRate_.add(index, value);
        onChanged();
      } else {
        answersToRateBuilder_.addMessage(index, value);
      }
      return this;
    }
    /**
    ...
    public Builder addAnswersToRate(
      ...
      if (answersToRateBuilder_ == null) {
        ensureAnswersToRateIsMutable();
        answersToRate_.add(builderForValue.build());
        onChanged();
      } else {
        answersToRateBuilder_.addMessage(builderForValue.build());
      }
      return this;
    }
    /**
    ...
    public Builder addAnswersToRate(
      ...
      if (answersToRateBuilder_ == null) {
        ensureAnswersToRateIsMutable();
        answersToRate_.add(index, builderForValue.build());
        onChanged();
      } else {
        answersToRateBuilder_.addMessage(index, builderForValue.build());
      }
      return this;
    }
    /**
    ...
    public Builder addAllAnswersToRate(
      ...
      if (answersToRateBuilder_ == null) {
        ensureAnswersToRateIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, answersToRate_);
        onChanged();
      } else {
        answersToRateBuilder_.addAllMessages(values);
      }
      return this;
    }
    /**
    ...
    public Builder removeAnswersToRate(int index) {
      if (answersToRateBuilder_ == null) {
        ensureAnswersToRateIsMutable();
        answersToRate_.remove(index);
        onChanged();
      } else {
        answersToRateBuilder_.remove(index);
      }
      return this;
    }
    /**
    ...
    public edu.kit.ipd.crowdcontrol.workerservice.proto.View.AnswerOrBuilder getAnswersToRateOrBuilder(
        int index) {
      if (answersToRateBuilder_ == null) {
        return answersToRate_.get(index);  } else {
        return answersToRateBuilder_.getMessageOrBuilder(index);
      }
    }
    /**
     * <code>repeated .crowdcontrol.View.Answer answers_to_rate = 7;</code>
    ...
    public java.util.List<? extends edu.kit.ipd.crowdcontrol.workerservice.proto.View.AnswerOrBuilder> 
         getAnswersToRateOrBuilderList() {
      if (answersToRateBuilder_ != null) {
        return answersToRateBuilder_.getMessageOrBuilderList();
      } else {
        return java.util.Collections.unmodifiableList(answersToRate_);
      }
    }
    ...
    public java.util.List<edu.kit.ipd.crowdcontrol.workerservice.proto.View.Answer.Builder> 
      ...
      return getAnswersToRateFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilder<
