...
CREATE TABLE IF NOT EXISTS `crowdcontrol`.`Answer_Reservation` (
  `id_answer_Reservation` INT NOT NULL AUTO_INCREMENT,
  `worker` INT NOT NULL,
  `experiment` INT NOT NULL,
  `timestamp` TIMESTAMP NOT NULL,
  `used` BIT(1) NOT NULL,
  PRIMARY KEY (`id_answer_Reservation`),
...
CREATE TABLE IF NOT EXISTS `crowdcontrol`.`Answer` (
  ...
  `quality_assured` BIT(1) NOT NULL DEFAULT FALSE,
  `system_response` VARCHAR(191) NULL,
  `hash` BIGINT NULL,
  `duplicate` BIT(1) NOT NULL DEFAULT FALSE,
  ...
  CONSTRAINT `reservation_answer`
    ...
    REFERENCES `crowdcontrol`.`Answer_Reservation` (`id_answer_Reservation`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `crowdcontrol`.`Rating_Reservation` (
  `id_reserverd_Rating` INT NOT NULL AUTO_INCREMENT,
  `worker` INT NOT NULL,
  `experiment` INT NOT NULL,
  `answer` INT NOT NULL,
  `timestamp` TIMESTAMP NOT NULL,
  `used` BIT(1) NOT NULL,
  PRIMARY KEY (`id_reserverd_Rating`),
...
CREATE TABLE IF NOT EXISTS `crowdcontrol`.`Rating` (
  ...
  CONSTRAINT `reservation_rating`
    FOREIGN KEY (`reservation`)
    REFERENCES `crowdcontrol`.`Rating_Reservation` (`id_reserverd_Rating`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `crowdcontrol`.`Experiments_Platform_Status` (
  `id_experiments_Platform_Status` INT NOT NULL AUTO_INCREMENT,
  `platform_status` ENUM('draft', 'failedPublishing', 'running', 'finished', 'creative_stopping', 'shutdown', 'shutdown_failed') NOT NULL DEFAULT 'draft',
  `timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `platform` INT NOT NULL,
  PRIMARY KEY (`id_experiments_Platform_Status`),
...
CREATE TABLE IF NOT EXISTS `crowdcontrol`.`Experiments_Platform_Mode` (
  `id_Experiments_Platform_Mode` INT NOT NULL AUTO_INCREMENT,
  `experiments_platform` INT NOT NULL,
  `mode` ENUM('answer', 'rating', 'normal') NOT NULL,
  `timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_Experiments_Platform_Mode`),
