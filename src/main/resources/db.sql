...
CREATE TABLE IF NOT EXISTS `crowdcontrol`.`Experiments_Platform_Status` (
  ...
  `platform_status` ENUM('draft', 'failedPublishing', 'running', 'finished', 'creative_stopping', 'shutdown', 'shutdown_started') NOT NULL DEFAULT 'draft',
  `timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
